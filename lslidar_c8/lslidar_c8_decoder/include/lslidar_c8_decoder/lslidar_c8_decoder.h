...
#ifndef LSLIDAR_C8_DECODER_H
#define LSLIDAR_C8_DECODER_H
...
#include <lslidar_c8_msgs/LslidarC8Point.h>
#include <lslidar_c8_msgs/LslidarC8Scan.h>
#include <lslidar_c8_msgs/LslidarC8Sweep.h>
#include <lslidar_c8_msgs/LslidarC8Layer.h>
...
class LslidarC8Decoder {
public:

    LslidarC8Decoder(ros::NodeHandle& n, ros::NodeHandle& pn);
    LslidarC8Decoder(const LslidarC8Decoder&) = delete;
    LslidarC8Decoder operator=(const LslidarC8Decoder&) = delete;
    ~LslidarC8Decoder() {return;}

    bool initialize();

    typedef boost::shared_ptr<LslidarC8Decoder> LslidarC8DecoderPtr;
    typedef boost::shared_ptr<const LslidarC8Decoder> LslidarC8DecoderConstPtr;
...
private:
    ...
    void packetCallback(const lslidar_c8_msgs::LslidarC8PacketConstPtr& msg);
    // Publish data
    ...
    lslidar_c8_msgs::LslidarC8SweepPtr sweep_data;
    lslidar_c8_msgs::LslidarC8LayerPtr multi_scan;
...
typedef LslidarC8Decoder::LslidarC8DecoderPtr LslidarC8DecoderPtr;
typedef LslidarC8Decoder::LslidarC8DecoderConstPtr LslidarC8DecoderConstPtr;
...
POINT_CLOUD_REGISTER_POINT_STRUCT(apollo::drivers::lslidar_c8_decoder::PointXYZIT,
